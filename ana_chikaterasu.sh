...
pbc=mol             # mol (default) or nojump (for protein complexes)
...
vmd=false           # Creates a folder vmd with ready-to-use gro/xtc file for viewing in VMD or to start a new universe in MDAnalysis
